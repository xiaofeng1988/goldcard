...
L.Control.Attribution = L.Control.extend({
    options: {
        ...
        prefix: '<a href="http://www.goldcard.com" title="goldcard Web Client">V1.0</a>'
    },
 ...
 * (2) modify 'http://leafletjs.com' to 'http://www.goldcard.com';
 ...
 */
L.Projection.goldcardGlobal = L.Class.extend({
  initialize: function()
  {
...
/*
 * CRS.goldcard is used for coordinate system of goldcard GIS
 */
L.CRS.goldcardGlobal = L.Class.extend({
  includes: L.CRS,
  transformation: new L.Transformation(1, 0, 1, 0),

  initialize: function()
  {
    this.projection = new L.Projection.goldcardGlobal();
  },
