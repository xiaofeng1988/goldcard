...
_22f.mask=$("<div class=\"window-mask\">"+iframe+"</div>").insertAfter(_22f.window);
...
_346[_347]=_348(_344);
/*********************modify by yq. start****************************/
_346[_347].on('mouseover',function(){
	//alert(_346[_347].panel('panel').html());
	if($('#mainlayout')!=null){
...
var iframe = "<iframe name='kill_activex' frameborder='0' style='position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;'></iframe>";
var _790=$("<div class=\"combo-panel\">"+iframe+"</div>").appendTo("body");
